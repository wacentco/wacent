...
const PUBLIC_PATHS = ['/login', '/register', '/forgot-password', '/reset-password', '/google-callback']
const AUTH_PATHS = ['/login', '/register', '/forgot-password', '/reset-password', '/google-callback']
