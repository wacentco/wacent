      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/register"
              className="w-full sm:w-auto px-8 py-3 rounded-xl font-semibold text-[#0A0F1E] bg-[#00D68F] hover:bg-[#00A36C] transition-colors text-base"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6">
            {[
              ...
              <div key={title} className="flex sm:flex-col items-start sm:items-center sm:text-center gap-4 sm:gap-3">
                {/* Mobile: step number inline; Desktop: icon */}
